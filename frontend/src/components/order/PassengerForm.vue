...
<template>
  <div class="passenger-form">
    <div class="toolbar">
      <el-button type="primary" @click="addPassenger">Add Passenger</el-button>
    </div>
    <el-table :data="modelValue" border>
      <el-table-column label="ID Number" min-width="210">
      ...
      <el-table-column label="Date of Birth" min-width="160">
        <template #default="{ row, $index }">
      ...
      <el-table-column label="Actions" width="90">
        <template #default="{ $index }">
          <el-button link type="danger" @click="removePassenger($index)">Delete</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
